...
export default function TradeLicenseFormationPage() {
  ...
  const content = {
    en: {
      heroTag: "UAE Trade License Services",
      heroTitle: "Trade License Services in UAE",
      heroDescription:
        "Obtain, renew, amend, or manage your UAE trade license with expert assistance. We handle documentation, approvals, renewals, and regulatory compliance for businesses across the UAE.",

      getService: "Get Service",

      benefitsTag: "Why Choose Our Trade License Services",
      benefitsTitle: "Benefits of Professional Trade License Assistance",
      benefitsDescription:
        "Ensure smooth business operations with fast, compliant, and hassle-free trade license services tailored to your business needs.",

      processTag: "Simple Process",
      processTitle1: "Trade License",
      processTitle2: "Process",
      processDescription:
        "Our specialists guide you through every step of obtaining or managing your UAE trade license.",
    },

    ar: {
      heroTag: "خدمات الرخص التجارية في الإمارات",
      heroTitle: "خدمات الرخص التجارية في دولة الإمارات",
      heroDescription:
        "احصل على الرخصة التجارية أو قم بتجديدها أو تعديلها بسهولة من خلال فريقنا المتخصص الذي يتولى جميع الإجراءات والموافقات والمتطلبات التنظيمية.",

      getService: "احصل على الخدمة",

      benefitsTag: "لماذا تختار خدمات الرخص التجارية لدينا",
      benefitsTitle: "مزايا الحصول على دعم احترافي للرخص التجارية",
      benefitsDescription:
        "نضمن لك إجراءات سريعة ومتوافقة مع الأنظمة لتأسيس وإدارة أعمالك دون تعقيدات.",

      processTag: "خطوات بسيطة",
      processTitle1: "إجراءات",
      processTitle2: "الرخصة التجارية",
      processDescription:
        "يرشدك خبراؤنا خلال جميع مراحل إصدار أو إدارة الرخصة التجارية في دولة الإمارات.",
    },
  };
  ...
  const benefits =
    selectedLanguage === "ar"
      ? [
          {
            title: "إصدار سريع للرخصة",
            description:
              "الحصول على الرخصة التجارية بسرعة وكفاءة مع متابعة كاملة للإجراءات.",
          },
          {
            title: "تجديد الرخصة بسهولة",
            description:
              "إدارة عمليات التجديد السنوية وتجنب الغرامات والتأخيرات.",
          },
          {
            title: "تعديل بيانات الرخصة",
            description:
              "إضافة أو إزالة الأنشطة التجارية وتحديث بيانات الشركة بسهولة.",
          },
          {
            title: "الالتزام بالأنظمة",
            description:
              "ضمان الامتثال الكامل للوائح والقوانين التجارية في دولة الإمارات.",
          },
          {
            title: "دعم الموافقات الحكومية",
            description:
              "الحصول على الموافقات المطلوبة من الجهات المختصة عند الحاجة.",
          },
          {
            title: "استشارات متخصصة",
            description:
              "الحصول على توجيهات احترافية لاختيار الرخصة المناسبة لنشاطك التجاري.",
          },
        ]
      : [
          {
            title: "Fast License Issuance",
            description:
              "Receive your trade license quickly with expert support throughout the process.",
          },
          {
            title: "Hassle-Free Renewals",
            description:
              "Manage annual renewals efficiently and avoid penalties or delays.",
          },
          {
            title: "License Amendments",
            description:
              "Add, remove, or modify business activities and company details with ease.",
          },
          {
            title: "Regulatory Compliance",
            description:
              "Ensure your business remains compliant with UAE licensing regulations.",
          },
          {
            title: "Government Approval Support",
            description:
              "Receive assistance obtaining approvals from relevant authorities when required.",
          },
          {
            title: "Professional Consultation",
            description:
              "Get expert guidance in selecting the right license for your business activity.",
          },
        ];
      ...
      ? [
          {
            ...
            description: "تحديد النشاط التجاري المناسب وفقاً لطبيعة أعمالك.",
          },
          {
            title: "اختيار نوع الرخصة",
            description:
              "اختيار الرخصة التجارية أو المهنية أو الصناعية المناسبة.",
          },
          {
            title: "حجز الاسم التجاري",
            description: "تسجيل الاسم التجاري وفقاً للوائح المعتمدة.",
          },
          {
            title: "الحصول على الموافقات",
            description:
              "استكمال الموافقات المطلوبة من الجهات الحكومية المختصة.",
          },
          {
            title: "إصدار الرخصة",
            description:
              "إتمام إجراءات إصدار الرخصة التجارية واستلام الوثائق الرسمية.",
          },
          {
            title: "التجديد والإدارة",
            description: "تقديم الدعم المستمر لتجديد وإدارة الرخصة التجارية.",
          },
        ]
      : [
          {
            ...
            description:
              "Identify the appropriate business activity for your operations.",
          },
          {
            title: "Choose License Type",
            description:
              "Select the correct commercial, professional, or industrial license.",
          },
          {
            title: "Trade Name Registration",
            description:
              "Reserve and register your company name according to regulations.",
          },
          {
            title: "Government Approvals",
            description:
              "Obtain approvals from relevant authorities where required.",
          },
          {
            title: "License Issuance",
            description:
              "Complete the licensing process and receive official company documents.",
          },
          {
            title: "Renewal & Ongoing Support",
            description:
              "Receive ongoing assistance for license renewals and amendments.",
          },
        ];
    ...
    <main className="bg-white pt-28 text-slate-900">
      ...
      <section className="relative overflow-hidden border-b border-white/10 bg-[#162235] text-white">
        ...
        <div
          ...
          style={{
            backgroundImage:
              "url('/images/banners/services/trade-license.avif')",
          }}
        />
        {/* Dark Overlay */}
