...
export default function MarriageCertificateAttestationPage() {
  ...
  const content = {
    en: {
      heroTag: "Marriage Certificate Attestation UAE",
      heroTitle: "Marriage Certificate Attestation Services",
      heroDescription:
        "Get your marriage certificate attested for family visa applications, residency, immigration, dependent sponsorship, legal procedures, and international use with our professional attestation services.",

      getService: "Get Service",

      benefitsTag: "Why Marriage Certificate Attestation",
      benefitsTitle: "Benefits of Marriage Certificate Attestation",
      benefitsDescription:
        "Marriage certificate attestation confirms the authenticity of your marital status and ensures acceptance by government authorities and institutions in the UAE and abroad.",

      processTag: "Simple Process",
      processTitle1: "Marriage Certificate",
      processTitle2: "Attestation Process",
      processDescription:
        "Our specialists handle every step of the attestation process to ensure your marriage certificate is accepted without delays.",
    },

    ar: {
      heroTag: "تصديق شهادة الزواج في الإمارات",
      heroTitle: "خدمات تصديق شهادة الزواج",
      heroDescription:
        "احصل على تصديق شهادة الزواج لأغراض تأشيرات الأسرة والإقامة وكفالة الزوج أو الزوجة والمعاملات القانونية والاستخدام الدولي من خلال خدماتنا الاحترافية.",

      getService: "احصل على الخدمة",

      benefitsTag: "لماذا تصديق شهادة الزواج",
      benefitsTitle: "مزايا تصديق شهادة الزواج",
      benefitsDescription:
        "يؤكد تصديق شهادة الزواج صحة الحالة الاجتماعية ويضمن قبول المستند لدى الجهات الحكومية والمؤسسات داخل الإمارات وخارجها.",

      processTag: "خطوات بسيطة",
      processTitle1: "عملية",
      processTitle2: "تصديق شهادة الزواج",
      processDescription:
        "يتولى خبراؤنا جميع مراحل التصديق لضمان اعتماد شهادة الزواج بسرعة وسهولة.",
    },
  };
  ...
  const benefits =
    selectedLanguage === "ar"
      ? [
          {
            title: "كفالة الزوج أو الزوجة",
            description:
              "مطلوب لتقديم طلبات كفالة الزوج أو الزوجة والإقامة العائلية في الإمارات.",
          },
          {
            title: "معاملات الهجرة",
            description:
              "دعم طلبات الهجرة والإقامة الدولية التي تتطلب إثبات الحالة الاجتماعية.",
          },
          {
            title: "الاعتراف القانوني",
            description:
              "ضمان الاعتراف الرسمي بشهادة الزواج لدى الجهات الحكومية والقانونية.",
          },
          {
            title: "إجراءات الأسرة",
            description:
              "تسهيل معاملات الأسرة والأبناء والخدمات الحكومية المختلفة.",
          },
          {
            title: "استخدام دولي",
            description:
              "تمكين استخدام شهادة الزواج في مختلف الدول والمؤسسات الدولية.",
          },
          {
            title: "خدمة آمنة وسريعة",
            description:
              "معالجة احترافية وسرية للمستندات مع متابعة مستمرة حتى الإنجاز.",
          },
        ]
      : [
          {
            title: "Spouse Sponsorship",
            description:
              "Required for spouse sponsorship and family residency visa applications in the UAE.",
          },
          {
            title: "Immigration Support",
            description:
              "Facilitates immigration and residency applications requiring proof of marital status.",
          },
          {
            title: "Legal Recognition",
            description:
              "Ensures official recognition of your marriage certificate by authorities.",
          },
          {
            title: "Family-Related Procedures",
            description:
              "Supports family visa, child registration, and other governmental procedures.",
          },
          {
            title: "International Acceptance",
            description:
              "Allows your marriage certificate to be used across different countries and institutions.",
          },
          {
            title: "Secure & Fast Processing",
            description:
              "Professional document handling with complete confidentiality and timely completion.",
          },
        ];
      ...
      ? [
          {
            ...
            description:
              "التحقق من شهادة الزواج ومتطلبات التصديق الخاصة بالدولة المستهدفة.",
          },
          {
            title: "التوثيق المحلي",
            description:
              "الحصول على التصديقات الأولية من الجهات المختصة في بلد الإصدار.",
          },
          {
            title: "تصديق الجهات الحكومية",
            description:
              "استكمال إجراءات التصديق لدى الوزارات والهيئات المعنية.",
          },
          {
            title: "تصديق وزارة الخارجية",
            description:
              "الحصول على اعتماد وزارة الخارجية وفقاً للمتطلبات الرسمية.",
          },
          {
            title: "تصديق السفارة",
            description:
              "تقديم المستند للسفارة أو القنصلية المختصة للتصديق النهائي.",
          },
          {
            title: "التسليم النهائي",
            description: "استلام شهادة الزواج المصدقة وجاهزة للاستخدام الرسمي.",
          },
        ]
      : [
          {
            ...
            description:
              "Verify the marriage certificate and identify attestation requirements.",
          },
          {
            title: "Local Authentication",
            description:
              "Obtain initial verification from the issuing authority.",
          },
          {
            title: "Government Verification",
            description:
              "Complete authentication with the relevant government departments.",
          },
          {
          ...
          },
          {
            ...
            description:
              "Submit the certificate to the relevant embassy or consulate for final approval.",
          },
          {
            title: "Document Delivery",
            description:
              "Receive your fully attested marriage certificate ready for official use.",
          },
        ];
    ...
    <main className="bg-white pt-28 text-slate-900">
      ...
      <section className="relative overflow-hidden border-b border-white/10 bg-[#162235] text-white">
        ...
        <div
          ...
          style={{
            backgroundImage:
              "url('/images/banners/services/marriage-certificate-attestation.jpg')",
          }}
        />
        {/* Dark Overlay */}
