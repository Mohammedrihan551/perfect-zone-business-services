...
export default function BirthCertificateAttestationPage() {
  ...
  const content = {
    en: {
      heroTag: "Birth Certificate Attestation UAE",
      heroTitle: "Birth Certificate Attestation Services",
      heroDescription:
        "Get your birth certificate attested for family visa applications, child sponsorship, school admissions, immigration, residency, passport applications, and international legal requirements.",

      getService: "Get Service",

      benefitsTag: "Why Birth Certificate Attestation",
      benefitsTitle: "Benefits of Birth Certificate Attestation",
      benefitsDescription:
        "Birth certificate attestation validates the authenticity of personal records and ensures official acceptance by government authorities, educational institutions, and international organizations.",

      processTag: "Simple Process",
      processTitle1: "Birth Certificate",
      processTitle2: "Attestation Process",
      processDescription:
        "Our experts manage every stage of the attestation process to ensure your birth certificate is recognized and accepted without delays.",
    },

    ar: {
      heroTag: "تصديق شهادة الميلاد في الإمارات",
      heroTitle: "خدمات تصديق شهادة الميلاد",
      heroDescription:
        "احصل على تصديق شهادة الميلاد لأغراض تأشيرات الأسرة وكفالة الأبناء والقبول المدرسي والهجرة والإقامة وإصدار جوازات السفر والمتطلبات القانونية الدولية.",

      getService: "احصل على الخدمة",

      benefitsTag: "لماذا تصديق شهادة الميلاد",
      benefitsTitle: "مزايا تصديق شهادة الميلاد",
      benefitsDescription:
        "يؤكد تصديق شهادة الميلاد صحة البيانات الشخصية ويضمن قبولها لدى الجهات الحكومية والمؤسسات التعليمية والمنظمات الدولية.",

      processTag: "خطوات بسيطة",
      processTitle1: "عملية",
      processTitle2: "تصديق شهادة الميلاد",
      processDescription:
        "يتولى فريقنا جميع مراحل التصديق لضمان اعتماد شهادة الميلاد بسرعة وكفاءة.",
    },
  };
      ...
      ? [
          {
            title: "كفالة الأبناء",
            description:
              "مطلوب لإجراءات كفالة الأبناء والحصول على تأشيرات الإقامة العائلية.",
          },
          {
            title: "القبول المدرسي",
            description:
              "يساعد في استكمال متطلبات التسجيل والقبول في المدارس والجامعات.",
          },
          {
            title: "إجراءات الهجرة",
            description:
              "يدعم معاملات الهجرة والإقامة التي تتطلب إثبات بيانات الميلاد.",
          },
          {
            title: "إصدار جوازات السفر",
            description:
              "مطلوب في العديد من معاملات إصدار أو تجديد جوازات السفر للأطفال.",
          },
          {
            title: "الاعتراف الدولي",
            description:
              "يضمن قبول شهادة الميلاد لدى الجهات والمؤسسات الدولية المختلفة.",
          },
          {
            title: "خدمة آمنة وسريعة",
            description:
              "معالجة احترافية للمستندات مع متابعة مستمرة حتى اكتمال التصديق.",
          },
        ]
      : [
          {
            ...
            description:
              "Required for child sponsorship and family residency visa applications.",
          },
          {
            title: "School Admissions",
            description:
              "Supports enrollment requirements for schools, colleges, and universities.",
          },
          {
            title: "Immigration Procedures",
            description:
              "Facilitates immigration and residency applications requiring proof of birth.",
          },
          {
            title: "Passport Applications",
            description:
              "Often required for passport issuance and renewal procedures for children.",
          },
          {
            title: "International Recognition",
            description:
              "Ensures acceptance of birth certificates by international authorities and institutions.",
          },
          {
            title: "Secure & Fast Processing",
            description:
              "Professional document handling with continuous support throughout the process.",
          },
        ];
      ...
      ? [
          {
            ...
            description:
              "التحقق من شهادة الميلاد ومتطلبات التصديق الخاصة بالدولة المستهدفة.",
          },
          {
            title: "التوثيق الأولي",
            description:
              "الحصول على التصديقات المطلوبة من الجهات المختصة في بلد الإصدار.",
          },
          {
            title: "تصديق الجهات الحكومية",
            description:
              "استكمال التصديقات الرسمية لدى الوزارات والهيئات المختصة.",
          },
          {
            title: "تصديق وزارة الخارجية",
            description:
              "الحصول على اعتماد وزارة الخارجية وفقاً للمتطلبات القانونية.",
          },
          {
            title: "تصديق السفارة",
            description:
              "تقديم المستند إلى السفارة أو القنصلية المختصة للتصديق النهائي.",
          },
          {
            title: "تسليم المستند",
            description:
              "استلام شهادة الميلاد المصدقة وجاهزة للاستخدام الرسمي.",
          },
        ]
      : [
          {
            ...
            description:
              "Verify the birth certificate and determine country-specific requirements.",
          },
          {
            title: "Initial Authentication",
            description:
              "Obtain verification from the issuing authority or relevant department.",
          },
          {
            title: "Government Verification",
            description:
              "Complete authentication procedures with the required government authorities.",
          },
          {
            title: "MOFA Attestation",
            description:
              "Secure Ministry of Foreign Affairs attestation where applicable.",
          },
          {
          ...
          },
          {
            ...
            description:
              "Receive your fully attested birth certificate ready for official use.",
          },
        ];
    ...
    <main className="bg-white pt-28 text-slate-900">
      ...
      <section className="relative overflow-hidden border-b border-white/10 bg-[#162235] text-white">
        ...
        <div
          ...
          style={{
            backgroundImage:
              "url('/images/banners/services/birth-certificate-attestation.jpg')",
          }}
        />
        {/* Dark Overlay */}
