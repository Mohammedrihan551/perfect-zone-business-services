...
export default function CertifiedTranslationPage() {
  ...
  const content = {
    en: {
      heroTag: "Certified Translation Services UAE",
      heroTitle: "Certified Translation Services in UAE",
      heroDescription:
        "Professional certified translation services for personal, educational, legal, immigration, and business documents accepted by government authorities, embassies, universities, and private organizations across the UAE.",
      getService: "Get Service",

      benefitsTag: "Why Choose Our Services",
      benefitsTitle: "Benefits of Certified Translation",
      benefitsDescription:
        "Ensure your translated documents are accurate, officially recognized, and accepted by government entities, embassies, educational institutions, and businesses.",

      processTag: "Simple Process",
      processTitle1: "Translation",
      processTitle2: "Process",
      processDescription:
        "Our certified translators deliver accurate translations with official certification and quick turnaround times.",
    },

    ar: {
      heroTag: "خدمات الترجمة المعتمدة في الإمارات",
      heroTitle: "خدمات الترجمة المعتمدة في دولة الإمارات",
      heroDescription:
        "خدمات ترجمة معتمدة واحترافية للوثائق الشخصية والتعليمية والقانونية والهجرية والتجارية المعترف بها لدى الجهات الحكومية والسفارات والجامعات والمؤسسات الخاصة في دولة الإمارات.",

      getService: "احصل على الخدمة",

      benefitsTag: "لماذا تختار خدماتنا",
      benefitsTitle: "مزايا الترجمة المعتمدة",
      benefitsDescription:
        "نضمن ترجمة دقيقة ومعترف بها رسمياً وقابلة للاستخدام لدى الجهات الحكومية والسفارات والمؤسسات التعليمية والشركات المختلفة.",

      processTag: "خطوات بسيطة",
      processTitle1: "عملية",
      processTitle2: "الترجمة المعتمدة",
      processDescription:
        "يقدم مترجمونا المعتمدون ترجمات دقيقة مع الاعتماد الرسمي وسرعة الإنجاز.",
    },
  };
      ...
      ? [
          {
            title: "اعتماد رسمي",
            description:
              "ترجمات معترف بها لدى الوزارات والسفارات والجامعات والهيئات الحكومية.",
          },
          {
            title: "دقة احترافية",
            description:
              "ترجمة دقيقة للمصطلحات والمحتوى مع مراجعة شاملة للجودة.",
          },
          {
            title: "مترجمون معتمدون",
            description:
              "فريق من المترجمين المؤهلين والمعتمدين لمختلف اللغات والتخصصات.",
          },
          {
            title: "قبول عالمي",
            description:
              "مستندات مترجمة قابلة للاستخدام داخل الإمارات وخارجها.",
          },
          {
            title: "سرعة في التنفيذ",
            description: "إنجاز سريع للمشاريع العاجلة مع المحافظة على الجودة.",
          },
          {
            title: "دعم متعدد اللغات",
            description:
              "الترجمة بين العربية والإنجليزية والعديد من اللغات العالمية.",
          },
        ]
      : [
          {
            ...
            description:
              "Translations recognized by ministries, embassies, universities, and government authorities.",
          },
          {
            title: "Professional Accuracy",
            description:
              "Precise translation of content and terminology with quality assurance review.",
          },
          {
            title: "Certified Translators",
            description:
              "Qualified translators with expertise across multiple industries and languages.",
          },
          {
            title: "International Acceptance",
            description:
              "Translated documents suitable for use both inside and outside the UAE.",
          },
          {
            title: "Fast Delivery",
            description:
              "Quick turnaround times without compromising translation quality.",
          },
          {
            title: "Multi-Language Support",
            description:
              "Translation services covering Arabic, English, and numerous global languages.",
          },
        ];
      ...
      ? [
          {
            ...
            description:
              "إرسال الوثائق المطلوبة للترجمة إلكترونياً أو عبر مكتبنا.",
          },
          {
            title: "تقييم المستندات",
            description:
              "مراجعة نوع المستند واللغة المطلوبة ومتطلبات الاعتماد.",
          },
          {
            title: "الترجمة الاحترافية",
            description: "تنفيذ الترجمة بواسطة مترجمين معتمدين ومتخصصين.",
          },
          {
            title: "التدقيق والمراجعة",
            description: "فحص شامل لضمان الدقة اللغوية والتنسيق الصحيح.",
          },
          {
            title: "الاعتماد الرسمي",
            description: "إصدار شهادة الترجمة المعتمدة أو الأختام المطلوبة.",
          },
          {
            title: "التسليم النهائي",
            description: "تسليم النسخ النهائية إلكترونياً أو ورقياً حسب الطلب.",
          },
        ]
      : [
          {
            ...
            description:
              "Send your documents online or submit them through our office.",
          },
          {
            title: "Document Assessment",
            description:
              "Review document type, target language, and certification requirements.",
          },
          {
            title: "Professional Translation",
            description:
              "Certified translators accurately translate the document content.",
          },
          {
            title: "Proofreading & Review",
            description:
              "Comprehensive quality checks ensure accuracy and consistency.",
          },
          {
            title: "Official Certification",
            description:
              "Apply translator certification, stamps, or required attestations.",
          },
          {
            title: "Final Delivery",
            description:
              "Receive certified translations digitally or as hard copies.",
          },
        ];
