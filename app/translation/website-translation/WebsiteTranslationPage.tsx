...
export default function WebsiteTranslationPage() {
  ...
  const content = {
    en: {
      heroTag: "Website Translation Services",
      heroTitle: "Website Translation Services in UAE",
      heroDescription:
        "Professional website translation services to help businesses reach global audiences through multilingual websites, localized content, SEO-friendly translations, and culturally adapted user experiences.",
      getService: "Get Service",

      benefitsTag: "Why Choose Our Website Translation",
      benefitsTitle: "Key Benefits of Website Translation Services",
      benefitsDescription:
        "Expand your online presence internationally with accurate website translations that improve user engagement, trust, and search engine visibility across multiple markets.",

      processTag: "Simple Process",
      processTitle1: "Website Translation",
      processTitle2: "Process",
      processDescription:
        "Our localization specialists translate and adapt your website content to deliver a seamless multilingual experience for global visitors.",
    },

    ar: {
      heroTag: "خدمات ترجمة المواقع الإلكترونية",
      heroTitle: "خدمات ترجمة المواقع الإلكترونية في الإمارات",
      heroDescription:
        "خدمات احترافية لترجمة المواقع الإلكترونية تساعد الشركات على الوصول إلى جمهور عالمي من خلال مواقع متعددة اللغات ومحتوى محلي متوافق مع الأسواق المستهدفة.",
      getService: "احصل على الخدمة",

      benefitsTag: "لماذا تختار ترجمة المواقع لدينا",
      benefitsTitle: "أهم مزايا خدمات ترجمة المواقع الإلكترونية",
      benefitsDescription:
        "وسع حضورك الرقمي عالمياً من خلال ترجمة دقيقة للمواقع الإلكترونية تعزز التفاعل والثقة وتحسن الظهور في محركات البحث.",

      processTag: "خطوات بسيطة",
      processTitle1: "عملية",
      processTitle2: "ترجمة المواقع",
      processDescription:
        "يقوم خبراؤنا بترجمة وتوطين محتوى موقعك الإلكتروني لضمان تجربة مستخدم سلسة وفعالة بلغات متعددة.",
    },
  };
  ...
  const benefits =
    selectedLanguage === "ar"
      ? [
          {
            title: "الوصول إلى جمهور عالمي",
            description:
              "التواصل مع العملاء حول العالم من خلال محتوى مترجم باحترافية.",
          },
          {
            title: "تحسين محركات البحث",
            description:
              "تهيئة الصفحات المترجمة لمحركات البحث في الأسواق واللغات المستهدفة.",
          },
          {
            title: "تجربة مستخدم أفضل",
            description:
              "تقديم محتوى محلي يتناسب مع ثقافة واحتياجات الزوار الدوليين.",
          },
          {
            title: "الحفاظ على هوية العلامة التجارية",
            description:
              "ضمان اتساق الرسائل التسويقية والهوية المؤسسية عبر جميع اللغات.",
          },
          {
            title: "دعم المواقع متعددة اللغات",
            description:
              "ترجمة الصفحات التعريفية وصفحات الخدمات والمتاجر الإلكترونية والمدونات.",
          },
          {
            title: "زيادة معدلات التحويل",
            description: "تعزيز ثقة العملاء وتحسين نتائج المبيعات والتفاعل.",
          },
        ]
      : [
          {
            ...
            description:
              "Connect with customers worldwide through professionally translated website content.",
          },
          {
            title: "SEO-Friendly Localization",
            description:
              "Optimize translated pages for search engines in target languages and regions.",
          },
          {
            title: "Enhanced User Experience",
            description:
              "Deliver localized content that feels natural and engaging to international visitors.",
          },
          {
            title: "Brand Consistency",
            description:
              "Maintain your brand voice and messaging across all language versions.",
          },
          {
            title: "Multilingual Website Support",
            description:
              "Translate landing pages, product pages, blogs, and entire websites.",
          },
          {
            title: "Higher Conversion Rates",
            description:
              "Increase customer trust and improve conversions through localized communication.",
          },
        ];
      ...
      ? [
          {
            title: "مراجعة الموقع",
            description:
              "تحليل هيكل الموقع والمحتوى واللغات المطلوبة ومتطلبات التوطين.",
          },
          {
            title: "استخراج المحتوى",
            description:
              "تحديد الصفحات والقوائم والبيانات الوصفية والمحتوى المطلوب ترجمته.",
          },
          {
            title: "الترجمة والتوطين",
            description:
              "ترجمة المحتوى مع تكييفه ثقافياً ولغوياً بما يتناسب مع الجمهور المستهدف.",
          },
          {
            title: "تحسين محركات البحث",
            description:
              "توطين الكلمات المفتاحية والعناوين والبيانات الوصفية لزيادة الظهور الرقمي.",
          },
          {
            title: "مراجعة الجودة",
            description:
              "التأكد من دقة الترجمة واتساق المحتوى وسهولة الاستخدام.",
          },
          {
            title: "دعم النشر",
            description:
              "المساعدة في نشر المحتوى المترجم على الموقع الإلكتروني.",
          },
        ]
      : [
          {
            ...
            description:
              "Analyze website structure, content volume, languages, and localization requirements.",
          },
          {
            title: "Content Extraction",
            description:
              "Identify and prepare website pages, menus, metadata, and content for translation.",
          },
          {
            title: "Translation & Localization",
            description:
              "Translate website content while adapting language and cultural references.",
          },
          {
            title: "SEO Optimization",
            description:
              "Localize keywords, page titles, and metadata for multilingual search visibility.",
          },
          {
            title: "Quality Assurance",
            description:
              "Review translated content for accuracy, consistency, and user experience.",
          },
          {
            title: "Deployment Support",
            description:
              "Assist with publishing translated content on your website platform.",
          },
        ];
