...
export default function BusinessTranslationPage() {
  ...
  const content = {
    en: {
      heroTag: "Business Translation Services",
      heroTitle: "Business Translation Services in UAE",
      heroDescription:
        "Professional business translation services for contracts, corporate communications, financial reports, company profiles, proposals, presentations, and commercial documents with complete linguistic accuracy and confidentiality.",
      getService: "Get Service",

      benefitsTag: "Why Choose Our Business Translation",
      benefitsTitle: "Key Benefits of Business Translation Services",
      benefitsDescription:
        "Facilitate international business operations through accurate, culturally appropriate, and industry-specific business translations that help organizations communicate confidently across global markets.",

      processTag: "Simple Process",
      processTitle1: "Business Translation",
      processTitle2: "Process",
      processDescription:
        "Our business translation experts ensure your corporate documents are translated accurately while maintaining professional tone, clarity, and compliance.",
    },

    ar: {
      heroTag: "خدمات الترجمة التجارية",
      heroTitle: "خدمات الترجمة التجارية في الإمارات",
      heroDescription:
        "خدمات ترجمة تجارية احترافية للعقود والتقارير المالية والملفات التعريفية للشركات والعروض التجارية والمراسلات المؤسسية والوثائق التجارية مع ضمان الدقة والسرية.",
      getService: "احصل على الخدمة",

      benefitsTag: "لماذا تختار الترجمة التجارية لدينا",
      benefitsTitle: "أهم مزايا خدمات الترجمة التجارية",
      benefitsDescription:
        "دعم العمليات التجارية الدولية من خلال ترجمات دقيقة ومتوافقة ثقافياً تساعد الشركات على التواصل بثقة في الأسواق العالمية.",

      processTag: "خطوات بسيطة",
      processTitle1: "عملية",
      processTitle2: "الترجمة التجارية",
      processDescription:
        "يضمن خبراؤنا ترجمة وثائق الأعمال بدقة مع الحفاظ على الطابع المهني والوضوح والامتثال.",
    },
  };
  ...
  const benefits =
    selectedLanguage === "ar"
      ? [
          {
            title: "مصطلحات تجارية احترافية",
            description: "ترجمة دقيقة للمصطلحات التجارية والمؤسسية والمالية.",
          },
          {
            title: "التواصل مع الأسواق العالمية",
            description:
              "دعم التوسع الدولي من خلال التواصل التجاري متعدد اللغات.",
          },
          {
            title: "سرية الوثائق",
            description: "معالجة آمنة للوثائق المالية والتجارية الحساسة.",
          },
          {
            title: "التكيّف الثقافي",
            description: "ضمان ملاءمة الرسائل التجارية للأسواق المستهدفة.",
          },
          {
            title: "سرعة الإنجاز",
            description:
              "تسليم سريع لتلبية احتياجات الأعمال والمواعيد النهائية.",
          },
          {
            title: "دقة عالية",
            description:
              "الحفاظ على الوضوح والاتساق والاحترافية في جميع الوثائق.",
          },
        ]
      : [
          {
            title: "Professional Business Terminology",
            description:
              "Accurate translation of business, corporate, and commercial terminology.",
          },
          {
            title: "Global Market Communication",
            description:
              "Support international expansion through multilingual business communication.",
          },
          {
            title: "Confidential Document Handling",
            description:
              "Secure processing of sensitive corporate and financial information.",
          },
          {
            title: "Cultural Adaptation",
            description:
              "Ensure messages are culturally appropriate for target markets.",
          },
          {
            title: "Fast Turnaround Times",
            description:
              "Efficient delivery for urgent business requirements and deadlines.",
          },
          {
            title: "High Translation Accuracy",
            description:
              "Maintain clarity, consistency, and professionalism across all documents.",
          },
        ];
      ...
      ? [
          {
            title: "تقديم الوثائق",
            description:
              "إرسال العقود أو التقارير أو العروض التقديمية أو المقترحات أو غيرها من وثائق الأعمال.",
          },
          {
            title: "تقييم المشروع",
            description: "مراجعة نوع الوثيقة واللغات المطلوبة ومتطلبات القطاع.",
          },
          {
            title: "تخصيص المترجم",
            description: "تعيين مترجم أعمال متخصص وذو خبرة في المجال المطلوب.",
          },
          {
            title: "الترجمة التجارية",
            description:
              "ترجمة المحتوى مع الحفاظ على المعنى والطابع المهني والهدف التجاري.",
          },
          {
            title: "ضمان الجودة",
            description: "إجراء مراجعات لغوية دقيقة وفحوصات للاتساق والجودة.",
          },
          {
            title: "التسليم النهائي",
            description:
              "استلام الوثائق التجارية المترجمة بشكل احترافي وجاهزة للاستخدام.",
          },
        ]
      : [
          {
            ...
            description:
              "Submit contracts, reports, presentations, proposals, or other business documents.",
          },
          {
            title: "Project Evaluation",
            description:
              "Review document type, language pair, and industry-specific requirements.",
          },
          {
            title: "Translator Assignment",
            description:
              "Assign experienced business translators familiar with your industry.",
          },
          {
            title: "Business Translation",
            description:
              "Translate content while preserving meaning, professionalism, and intent.",
          },
          {
            title: "Quality Assurance",
            description:
              "Perform comprehensive proofreading and consistency checks.",
          },
          {
            title: "Final Delivery",
            description:
              "Receive professionally translated business documents ready for immediate use.",
          },
        ];
