...
export default function LegalTranslationPage() {
  ...
  const content = {
    en: {
      heroTag: "UAE Legal Translation Services",
      heroTitle: "Legal Translation Services in UAE",
      heroDescription:
        "Accurate and certified legal translation services for official documents, contracts, certificates, court documents, immigration papers, and business records accepted by UAE authorities.",
      getService: "Get Service",

      benefitsTag: "Why Choose Our Services",
      benefitsTitle: "Benefits of Professional Legal Translation",
      benefitsDescription:
        "Ensure your documents are accurately translated, legally compliant, and accepted by government authorities, embassies, courts, and businesses across the UAE.",

      processTag: "Simple Process",
      processTitle1: "Translation",
      processTitle2: "Process",
      processDescription:
        "Our certified translators ensure every document is translated accurately and delivered on time.",
    },

    ar: {
      heroTag: "خدمات الترجمة القانونية في الإمارات",
      heroTitle: "خدمات الترجمة القانونية في الإمارات",
      heroDescription:
        "خدمات ترجمة قانونية دقيقة ومعتمدة للعقود والشهادات والوثائق الرسمية والمستندات القضائية والهجرة والسجلات التجارية المعترف بها لدى الجهات الرسمية في دولة الإمارات.",

      getService: "احصل على الخدمة",

      benefitsTag: "لماذا تختار خدماتنا",
      benefitsTitle: "مزايا الترجمة القانونية الاحترافية",
      benefitsDescription:
        "نضمن ترجمة دقيقة ومتوافقة قانونياً لمستنداتك وقبولها لدى الجهات الحكومية والسفارات والمحاكم والمؤسسات المختلفة في دولة الإمارات.",

      processTag: "خطوات بسيطة",
      processTitle1: "عملية",
      processTitle2: "الترجمة القانونية",
      processDescription:
        "يقوم مترجمونا المعتمدون بترجمة مستنداتك بدقة واحترافية مع الالتزام بالمواعيد المحددة.",
    },
  };
  ...
  const benefits =
    selectedLanguage === "ar"
      ? [
          {
            title: "مترجمون قانونيون معتمدون",
            description:
              "فريق متخصص من المترجمين القانونيين المعتمدين من الجهات المختصة في دولة الإمارات.",
          },
          {
            title: "قبول رسمي",
            description:
              "الترجمات معترف بها لدى الوزارات والسفارات والمحاكم والهيئات الحكومية.",
          },
          {
            title: "دقة عالية",
            description:
              "مراجعة دقيقة لضمان صحة المصطلحات القانونية وعدم وجود أخطاء.",
          },
          {
            title: "سرية تامة",
            description: "التعامل مع جميع الوثائق بسرية وخصوصية كاملة.",
          },
          {
            title: "سرعة الإنجاز",
            description: "إتمام مشاريع الترجمة وتسليمها ضمن الوقت المطلوب.",
          },
          {
            title: "ترجمة متعددة اللغات",
            description:
              "خدمات ترجمة بين العربية والإنجليزية والعديد من اللغات العالمية.",
          },
        ]
      : [
          {
            ...
            description:
              "Qualified legal translators approved to provide official and accurate document translations.",
          },
          {
            title: "Official Acceptance",
            description:
              "Translations accepted by ministries, embassies, courts, and government authorities.",
          },
          {
            title: "High Accuracy",
            description:
              "Careful review process ensuring precise legal terminology and compliance.",
          },
          {
            title: "Complete Confidentiality",
            description:
              "Your personal and business documents are handled securely and confidentially.",
          },
          {
            title: "Fast Turnaround",
            description:
              "Efficient translation services delivered within agreed timelines.",
          },
          {
            title: "Multiple Language Support",
            description:
              "Professional translation services across Arabic, English, and many international languages.",
          },
        ];
      ...
      ? [
          {
            ...
            description:
              "مشاركة الوثائق المطلوب ترجمتها عبر الإنترنت أو من خلال مكتبنا.",
          },
          {
            title: "مراجعة المتطلبات",
            description:
              "تقييم المستندات وتحديد اللغة المستهدفة والمتطلبات القانونية.",
          },
          {
            title: "الترجمة القانونية",
            description:
              "تنفيذ الترجمة بواسطة مترجمين قانونيين معتمدين ومتخصصين.",
          },
          {
            title: "التدقيق والمراجعة",
            description: "مراجعة شاملة لضمان الدقة اللغوية والقانونية.",
          },
          {
            title: "الاعتماد والتصديق",
            description:
              "إضافة الأختام أو الاعتمادات المطلوبة حسب الجهة المستفيدة.",
          },
          {
            title: "التسليم النهائي",
            description: "تسليم النسخ المترجمة إلكترونياً أو ورقياً حسب الطلب.",
          },
        ]
      : [
          {
            ...
            description:
              "Submit your documents online or through our office for translation.",
          },
          {
            title: "Requirement Review",
            description:
              "Our team reviews the documents and determines translation requirements.",
          },
          {
            title: "Legal Translation",
            description:
              "Certified legal translators accurately translate the documents.",
          },
          {
            title: "Quality Check",
            description:
              "Comprehensive proofreading and verification of legal terminology.",
          },
          {
            title: "Certification & Stamping",
            description:
              "Apply required certifications or official stamps when needed.",
          },
          {
            title: "Final Delivery",
            description:
              "Receive translated documents digitally or in hard copy format.",
          },
        ];
