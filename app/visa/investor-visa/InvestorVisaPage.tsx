...
export default function InvestorVisaPage() {
  ...
  const content = {
    en: {
      heroTag: "UAE Investor Visa Services",
      heroTitle: "Investor Visa Assistance in UAE",
      heroDescription:
        "Professional UAE investor visa services for entrepreneurs, shareholders, company owners, and investors seeking residency through business ownership or investment activities in the UAE.",
      getService: "Get Service",

      benefitsTag: "Why Choose Our Investor Visa Services",
      benefitsTitle: "Benefits of UAE Investor Visa",
      benefitsDescription:
        "Establish your presence in the UAE with expert support for investor visa applications, company documentation, approvals, and residency processing.",

      processTag: "Simple Process",
      processTitle1: "Investor Visa",
      processTitle2: "Application Process",
      processDescription:
        "Our specialists manage every stage of your investor visa application, ensuring compliance, efficiency, and a smooth approval process.",
    },

    ar: {
      heroTag: "خدمات تأشيرة المستثمر في الإمارات",
      heroTitle: "خدمات تأشيرة المستثمر في الإمارات",
      heroDescription:
        "خدمات احترافية لتأشيرة المستثمر في الإمارات لرواد الأعمال والمساهمين وأصحاب الشركات والمستثمرين الراغبين في الحصول على الإقامة من خلال الاستثمار أو ملكية الأعمال.",
      getService: "احصل على الخدمة",

      benefitsTag: "لماذا تختار خدمات تأشيرة المستثمر لدينا",
      benefitsTitle: "مزايا تأشيرة المستثمر الإماراتية",
      benefitsDescription:
        "احصل على الإقامة في الإمارات من خلال الاستثمار مع دعم كامل في إجراءات التأشيرة والموافقات الحكومية وتجهيز المستندات.",

      processTag: "خطوات بسيطة",
      processTitle1: "عملية",
      processTitle2: "تأشيرة المستثمر",
      processDescription:
        "يتولى خبراؤنا جميع مراحل طلب تأشيرة المستثمر لضمان تجربة سلسة وسريعة ومتوافقة مع الأنظمة الإماراتية.",
    },
  };
  ...
  const benefits =
    selectedLanguage === "ar"
      ? [
          {
            title: "إقامة للمستثمر",
            description:
              "الحصول على إقامة في الإمارات من خلال الاستثمار أو ملكية الأعمال.",
          },
          {
            title: "دعم تأسيس الأعمال",
            description:
              "مساعدة في إجراءات تأسيس الشركات وربطها بطلب التأشيرة.",
          },
          {
            title: "ملكية الأعمال",
            description:
              "الاستفادة من مزايا امتلاك وإدارة الأعمال داخل الإمارات.",
          },
          {
            title: "تجهيز المستندات",
            description: "إعداد ومراجعة جميع الوثائق المطلوبة للتقديم.",
          },
          {
            title: "متابعة الموافقات الحكومية",
            description: "التنسيق مع الجهات المختصة حتى اكتمال الإجراءات.",
          },
          {
            title: "استشارات استثمارية متخصصة",
            description:
              "إرشادات احترافية لاختيار المسار الأنسب للحصول على التأشيرة.",
          },
        ]
      : [
          {
            ...
            description:
              "Obtain UAE residency through qualifying investments or business ownership.",
          },
          {
            title: "Business Setup Support",
            description:
              "Assistance with company formation linked to investor visa applications.",
          },
          {
            title: "Business Ownership Benefits",
            description:
              "Enjoy the advantages of owning and managing a UAE business.",
          },
          {
          ...
          },
          {
            ...
            description:
              "Professional advice on the most suitable investor visa pathway.",
          },
        ];
      ...
      ? [
          {
            ...
            description: "مراجعة أهداف الاستثمار ومتطلبات التأشيرة.",
          },
          {
            title: "تقييم الأهلية",
            description: "التحقق من أهلية المستثمر ونوع الاستثمار المطلوب.",
          },
          {
            title: "تجهيز المستندات",
            description: "جمع وإعداد جميع الوثائق اللازمة للتقديم.",
          },
          {
            title: "تقديم الطلب",
            description: "تقديم طلب تأشيرة المستثمر إلى الجهات المختصة.",
          },
          {
          ...
          },
          {
            ...
            description: "استلام تأشيرة المستثمر واستكمال إجراءات الإقامة.",
          },
        ]
      : [
          {
            title: "Initial Consultation",
            description: "Review investment objectives and visa requirements.",
          },
          {
            title: "Eligibility Assessment",
            description:
              "Evaluate investor qualifications and investment criteria.",
          },
          {
            title: "Document Preparation",
            description:
          ...
          },
          {
            ...
            description:
              "Submit the investor visa application to relevant authorities.",
          },
          {
            title: "Approval Follow-Up",
            description:
              "Track application status and manage additional requirements.",
          },
          {
            title: "Visa Issuance",
            description:
              "Receive the investor visa and complete residency formalities.",
          },
        ];
