...
export default function FamilyVisaPage() {
  ...
  const content = {
    en: {
      heroTag: "UAE Family Visa Services",
      heroTitle: "Family Visa Assistance in UAE",
      heroDescription:
        "Professional UAE family visa services for sponsoring spouses, children, parents, and dependents. We handle documentation, applications, approvals, and visa processing from start to finish.",
      getService: "Get Service",

      benefitsTag: "Why Choose Our Family Visa Services",
      benefitsTitle: "Benefits of UAE Family Visa",
      benefitsDescription:
        "Bring your loved ones to the UAE with complete family visa support. Our experts assist with eligibility checks, document preparation, application submission, and government approvals.",

      processTag: "Simple Process",
      processTitle1: "Family Visa",
      processTitle2: "Application Process",
      processDescription:
        "Our visa specialists guide you through every stage of the UAE family visa application process for a smooth and hassle-free experience.",
    },

    ar: {
      heroTag: "خدمات تأشيرة الأسرة في الإمارات",
      heroTitle: "المساعدة في تأشيرة الأسرة في الإمارات",
      heroDescription:
        "خدمات احترافية لاستخراج تأشيرات الأسرة في الإمارات لكفالة الزوج أو الزوجة والأبناء والوالدين والمعالين مع دعم كامل في جميع الإجراءات.",
      getService: "احصل على الخدمة",

      benefitsTag: "لماذا تختار خدمات تأشيرة الأسرة لدينا",
      benefitsTitle: "مزايا تأشيرة الأسرة الإماراتية",
      benefitsDescription:
        "اجلب أفراد عائلتك إلى دولة الإمارات مع دعم متكامل يشمل التحقق من الأهلية وتجهيز المستندات وتقديم الطلبات والحصول على الموافقات.",

      processTag: "خطوات بسيطة",
      processTitle1: "عملية",
      processTitle2: "تأشيرة الأسرة",
      processDescription:
        "يساعدك خبراؤنا في جميع مراحل استخراج تأشيرة الأسرة الإماراتية لضمان تجربة سهلة وسريعة.",
    },
  };
  ...
  const benefits =
    selectedLanguage === "ar"
      ? [
          {
            title: "كفالة أفراد الأسرة",
            description:
              "إمكانية كفالة الزوج أو الزوجة والأبناء والوالدين وفق الشروط المعتمدة.",
          },
          {
            title: "دعم كامل للطلبات",
            description:
              "إدارة جميع مراحل التقديم بدءًا من تجهيز المستندات وحتى إصدار التأشيرة.",
          },
          {
            title: "تقييم الأهلية",
            description: "التحقق من استيفاء متطلبات الكفالة والإقامة.",
          },
          {
            title: "تجهيز المستندات",
            description: "مراجعة وإعداد جميع الوثائق المطلوبة بشكل صحيح.",
          },
          {
          ...
          },
          {
            ...
            description: "إرشادات احترافية لضمان نجاح طلب تأشيرة الأسرة.",
          },
        ]
      : [
          {
            ...
            description:
              "Sponsor your spouse, children, parents, and eligible dependents.",
          },
          {
          ...
          },
          {
            ...
            description:
              "Verify sponsorship requirements and visa eligibility.",
          },
          {
            title: "Document Preparation",
            description:
              "Professional review and preparation of required documents.",
          },
          {
          ...
          },
          {
            ...
            description:
              "Professional guidance to maximize application success.",
          },
        ];
      ...
      ? [
          {
            ...
            description: "مراجعة حالة الكفيل وتحديد متطلبات تأشيرة الأسرة.",
          },
          {
            title: "تقييم الأهلية",
            description: "التحقق من استيفاء شروط الكفالة والإقامة.",
          },
          {
            title: "تجهيز المستندات",
            description: "جمع ومراجعة جميع الوثائق المطلوبة للتقديم.",
          },
          {
            title: "تقديم الطلب",
            description: "تقديم طلب تأشيرة الأسرة إلى الجهات المختصة.",
          },
          {
          ...
          },
          {
            ...
            description: "استكمال الإجراءات النهائية واستلام تأشيرة الأسرة.",
          },
        ]
      : [
          {
            title: "Initial Consultation",
            description: "Review sponsor status and family visa requirements.",
          },
          {
            title: "Eligibility Assessment",
            description:
              "Verify sponsorship eligibility and compliance requirements.",
          },
          {
            title: "Document Preparation",
            description:
          ...
          },
          {
            ...
            description:
              "Submit the family visa application to relevant authorities.",
          },
          {
            title: "Approval Follow-Up",
            description:
              "Track application progress and handle additional requests.",
          },
          {
            title: "Visa Issuance",
            description:
              "Complete final procedures and receive the family visa.",
          },
        ];
    ...
    <main className="bg-white pt-28 text-slate-900">
      ...
      <section className="relative overflow-hidden border-b border-white/10 bg-[#162235] text-white">
        ...
        <div
          ...
          style={{
            backgroundImage: "url('/images/banners/services/family-visa.webp')",
          }}
        />
        {/* Dark Overlay */}
