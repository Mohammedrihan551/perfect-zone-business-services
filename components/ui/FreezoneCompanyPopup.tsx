...
export default function FreeZoneCompanyPopup({
  open,
  onClose,
  currentStep,
  name,
  ...
  const t = isArabic
    ? {
        ...
        setupTag: "تأسيس شركة في المنطقة الحرة",
        ...
        freeZone: "المنطقة الحرة المفضلة",
        activity: "النشاط التجاري بالتفصيل *",
        shareholders: "عدد المساهمين *",

        visaRequired: "هل تحتاج إلى تأشيرة إقامة؟",
        visaCount: "عدد التأشيرات المطلوبة",
        familyVisa: "هل تحتاج إلى كفالة عائلية؟",
        officeRequired: "هل تحتاج إلى مكتب / Flexi Desk؟",

        banking: "هل تحتاج إلى حساب مصرفي؟",
        warehouse: "هل تحتاج إلى مستودع؟",
        license: "نوع الرخصة",
    ...
    : {
        ...
        setupTag: "Free Zone Company Setup",
  ...
  const validateStep = () => {
    ...
    if (step === 2) {
      ...
      if (!form.freeZone)
        newErrors.freeZone = "Please select preferred free zone";
    ...
    if (step === 3) {
      ...
      if (!form.license) newErrors.license = "Please select license type";
    }
  ...
  const handleSubmitEmail = () => {
    ...
    const subject = "Free Zone Company Setup Inquiry";
...
Preferred Free Zone: ${form.freeZone}
...
Office Requirement: ${form.officeRequired}
Warehouse Required: ${form.warehouse}
...
`;
  ...
  const handleSubmitWhatsApp = () => {
    if (!validateStep()) return;
    const message = `
*Free Zone Company Setup Inquiry*
          ...
          {step === 3 && (
            <div className="grid gap-5 md:grid-cols-2">
              ...
              <Select
                ...
                onChange={handleChange}
                options={["Flexi Desk", "Private Office", "No"]}
