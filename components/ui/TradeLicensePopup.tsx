...
export default function TradeLicensePopup({
  open,
  onClose,
  currentStep,
  name,
  ...
  const t = isArabic
    ? {
        ...
        setupTag: "خدمات الرخصة التجارية",
    ...
    : {
        ...
        setupTag: "Trade License Services",
        ...
        shareholders: "Number of Partners *",

        jurisdiction: "Setup Type",
        emirate: "Preferred Emirate",
        renewal: "License Renewal?",
        amendment: "License Amendment?",

        officeRequired: "Need Office Space?",
        banking: "Need Bank Account Assistance?",
        visaRequired: "Need Visa Services?",
  ...
  const validateStep = () => {
    ...
    if (step === 2) {
      ...
      if (!form.jurisdiction)
        newErrors.jurisdiction = "Please select setup type";
  ...
  const handleSubmitEmail = () => {
    ...
    const subject = "Trade License Service Inquiry";
...
Company Status: ${form.companyStatus}
Business Activity:
${form.activity}

Setup Type: ${form.jurisdiction}
Number of Partners: ${form.owners}

Preferred Emirate: ${form.emirate}
License Renewal: ${form.renewal}
License Amendment: ${form.amendment}

Office Required: ${form.officeRequired}
Bank Account Assistance: ${form.banking}
Visa Services: ${form.visaRequired}
          ...
          {step === 2 && (
            <div className="grid gap-5 md:grid-cols-2">
              ...
              <Select
                ...
                onChange={handleChange}
                options={["Mainland", "Free Zone", "Offshore", "Not Sure"]}
