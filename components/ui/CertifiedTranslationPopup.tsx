...
export default function CertifiedTranslationPopup({
  open,
  onClose,
  currentStep,
  name,
  ...
  const t = isArabic
    ? {
        ...
        setupTag: "خدمات الترجمة المعتمدة",
        ...
        authority: "الجهة المطلوب تقديم المستند لها",
        hardCopy: "هل تحتاج نسخة مطبوعة؟",
        urgentService: "خدمة مستعجلة؟",
        delivery: "هل تحتاج توصيل؟",
    ...
    : {
        ...
        setupTag: "Certified Translation Services",
        ...
        delivery: "Need Delivery Service?",
  ...
  const handleSubmitEmail = () => {
    ...
    const subject = "Certified Translation Service Inquiry";
...
Submission Authority: ${form.authority}
Hard Copy Required: ${form.hardCopy}
Urgent Service: ${form.urgentService}
Delivery Service: ${form.delivery}
...
`;
  ...
  const handleSubmitWhatsApp = () => {
    if (!validateStep()) return;
    const message = `
*Certified Translation Service Inquiry*
