...
export default function PartnerVisaPopup({
  open,
  onClose,
  currentStep,
  name,
  ...
  const t = isArabic
    ...
    : {
        ...
        setupTag: "Partner Visa Assistance",
  ...
  const validateStep = () => {
    ...
    if (step === 2) {
      ...
      if (!form.ownershipPercentage)
        newErrors.ownershipPercentage = "Please select ownership percentage";
  ...
  const handleSubmitEmail = () => {
    ...
    const subject = "Partner Visa Inquiry";

    const body = `
PARTNER VISA INQUIRY
          ...
          {step === 2 && (
            <div className="grid gap-5 md:grid-cols-2">
              ...
              <Select
                ...
                onChange={handleChange}
                options={["Below 10%", "10% - 25%", "25% - 50%", "50%+"]}
          ...
          {step === 3 && (
            <div className="grid gap-5 md:grid-cols-2">
              <Select
                ...
                onChange={handleChange}
                options={["Registered", "In Setup Process", "Planning Stage"]}
