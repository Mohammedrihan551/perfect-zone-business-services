...
export default function TechnicalTranslationPopup({
  open,
  onClose,
  currentStep,
  name,
  ...
  const t = isArabic
    ? {
        ...
        setupTag: "خدمات الترجمة التقنية",
    ...
    : {
        ...
        setupTag: "Technical Translation Services",
        ...
        documentType: "Technical Document Type *",
        industry: "Industry *",
        sourceLanguage: "Source Language *",
        targetLanguage: "Target Language *",

        pageCount: "Number of Pages *",
        technicalLevel: "Technical Complexity",
  ...
  const handleSubmitEmail = () => {
    ...
    const subject = "Technical Translation Service Inquiry";
...
Technical Complexity: ${form.technicalLevel}
...
`;
  ...
  const handleSubmitWhatsApp = () => {
    if (!validateStep()) return;
    const message = `
*Technical Translation Service Inquiry*
