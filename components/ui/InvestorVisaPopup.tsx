...
export default function InvestorVisaPopup({
  open,
  onClose,
  currentStep,
  name,
  ...
  const t = isArabic
    ? {
        ...
        setupTag: "خدمات تأشيرة المستثمر",
        ...
        investmentLocation: "مكان الاستثمار *",
        businessSector: "قطاع الاستثمار *",

        businessStatus: "حالة المشروع",
        familySponsorship: "هل تحتاج كفالة عائلية؟",
        documentsReady: "هل المستندات جاهزة؟",
        residencyStatus: "حالة الإقامة الحالية",
    ...
    : {
        ...
        setupTag: "Investor Visa Assistance",
        ...
        familySponsorship: "Need Family Sponsorship?",
        documentsReady: "Documents Ready?",
        residencyStatus: "Current Residency Status",
  ...
  const validateStep = () => {
    ...
    if (step === 2) {
      if (!form.investmentType)
        newErrors.investmentType = "Please select investment type";

      if (!form.investmentAmount)
        newErrors.investmentAmount = "Please select investment amount";

      if (!form.investmentLocation)
        newErrors.investmentLocation = "Please select investment location";
  ...
  const handleSubmitEmail = () => {
    ...
    const subject = "Investor Visa Inquiry";

    const body = `
INVESTOR VISA INQUIRY
...
Investment Location: ${form.investmentLocation}
Business Sector: ${form.businessSector}

Business Status: ${form.businessStatus}
Family Sponsorship: ${form.familySponsorship}
Documents Ready: ${form.documentsReady}
Residency Status: ${form.residencyStatus}
        ...
        <div className="p-6">
          ...
          {step === 2 && (
            <div className="grid gap-5 md:grid-cols-2">
              ...
              <Select
                label={t.investmentLocation}
                name="investmentLocation"
                value={form.investmentLocation}
                onChange={handleChange}
                options={[
                  "Dubai",
                  "Abu Dhabi",
                ...
                error={errors.investmentLocation}
              />
