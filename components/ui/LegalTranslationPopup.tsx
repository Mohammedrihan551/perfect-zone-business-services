...
export default function LegalTranslationPopup({
  open,
  onClose,
  currentStep,
  name,
  ...
  const t = isArabic
    ? {
        ...
        setupTag: "خدمات الترجمة القانونية",
    ...
    : {
        ...
        setupTag: "Legal Translation Services",
        ...
        documentType: "Legal Document Type *",
        sourceLanguage: "Source Language *",
        targetLanguage: "Target Language *",
        pageCount: "Number of Pages *",

        notarization: "Need Notarization?",
        attestation: "Need Attestation?",
        urgentService: "Need Urgent Service?",
        certifiedTranslation: "Need Certified Translation?",
  ...
  const handleSubmitEmail = () => {
    ...
    const subject = "Legal Translation Service Inquiry";
...
Notarization Required: ${form.notarization}
Attestation Required: ${form.attestation}
Urgent Service: ${form.urgentService}
Certified Translation: ${form.certifiedTranslation}
...
`;
  ...
  const handleSubmitWhatsApp = () => {
    if (!validateStep()) return;
    const message = `
*Legal Translation Service Inquiry*
      ...
      <div className="max-h-[90vh] w-full max-w-4xl overflow-y-auto rounded-3xl border border-white/10 bg-[#162235] text-white shadow-2xl">
        ...
        <div className="p-6">
          ...
          {step === 3 && (
            <div className="grid gap-5 md:grid-cols-2">
              <Select
                label={t.notarization}
                name="notarization"
                value={form.notarization}
                onChange={handleChange}
                options={["Yes", "No"]}
                error={errors.notarization}
              />
              ...
              <Select
                label={t.certifiedTranslation}
                name="certifiedTranslation"
                value={form.certifiedTranslation}
                onChange={handleChange}
                options={["Yes", "No"]}
                error={errors.certifiedTranslation}
              />
            </div>
          )}
