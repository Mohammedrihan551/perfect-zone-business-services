...
export default function MarriageCertificateAttestationPopup({
  open,
  onClose,
  currentStep,
  name,
  ...
  const t = isArabic
    ? {
        ...
        setupTag: "خدمات تصديق شهادة الزواج",
        ...
        certificateCountry: "بلد إصدار الشهادة *",
        certificateCount: "عدد الشهادات *",
        purpose: "الغرض من التصديق *",
        certificateLanguage: "لغة الوثيقة",

        homeAttested: "موثقة في بلد الإصدار؟",
        embassyRequired: "هل تحتاج تصديق السفارة؟",
    ...
    : {
        ...
        setupTag: "Marriage Certificate Attestation Services",
        ...
        certificateCountry: "Certificate Issuing Country *",
        certificateCount: "Number of Certificates *",
        purpose: "Purpose of Attestation *",
        certificateLanguage: "Document Language",

        homeAttested: "Attested in Home Country?",
        embassyRequired: "Need Embassy Attestation?",
  ...
  const validateStep = () => {
    ...
    if (step === 2) {
      if (!form.certificateCountry)
        newErrors.certificateCountry =
          "Please select certificate issuing country";
  ...
  const handleSubmitEmail = () => {
    ...
    const subject = "Marriage Certificate Attestation Inquiry";

    const body = `
MARRIAGE CERTIFICATE ATTESTATION SERVICE
...
Certificate Country: ${form.certificateCountry}
Certificate Count: ${form.certificateCount}
Purpose: ${form.purpose}
Document Language: ${form.certificateLanguage}

Attested in Home Country: ${form.homeAttested}
Embassy Attestation Required: ${form.embassyRequired}
...
`;
  ...
  const handleSubmitWhatsApp = () => {
    if (!validateStep()) return;
    const message = `
*Marriage Certificate Attestation Inquiry*
        ...
        <div className="p-6">
          ...
          {step === 2 && (
            <div className="grid gap-5 md:grid-cols-2">
              ...
              <Select
                label={t.certificateLanguage}
                name="certificateLanguage"
                value={form.certificateLanguage}
                onChange={handleChange}
                options={["English", "Arabic", "Hindi", "Urdu", "Other"]}
          ...
          {step === 3 && (
            <div className="grid gap-5 md:grid-cols-2">
              <Select
                label={t.homeAttested}
                name="homeAttested"
                value={form.homeAttested}
                onChange={handleChange}
                options={["Yes", "No", "Not Sure"]}
                error={errors.homeAttested}
              />

              <Select
                label={t.embassyRequired}
                name="embassyRequired"
                value={form.embassyRequired}
                onChange={handleChange}
                options={["Yes", "No", "Not Sure"]}
                error={errors.embassyRequired}
              />
