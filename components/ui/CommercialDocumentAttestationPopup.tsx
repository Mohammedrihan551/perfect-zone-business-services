...
export default function CommercialDocumentAttestationPopup({
  open,
  onClose,
  currentStep,
  name,
  ...
  const t = isArabic
    ? {
        ...
        setupTag: "خدمات تصديق المستندات التجارية",
        ...
        issuingCountry: "بلد إصدار المستند *",
        documentCount: "عدد المستندات *",
        purpose: "الغرض من التصديق *",

        chamberAttested: "مصدق من غرفة التجارة؟",
    ...
    : {
        ...
        setupTag: "Commercial Document Attestation Services",
  ...
  const validateStep = () => {
    ...
    if (step === 2) {
      ...
      if (!form.documentCount)
        newErrors.documentCount = "Please select Number of Documents";
  ...
  const handleSubmitEmail = () => {
    ...
    const subject = "Commercial Document Attestation Inquiry";

    const body = `
COMMERCIAL DOCUMENT ATTESTATION SERVICE
...
Document Count: ${form.documentCount}
Purpose: ${form.purpose}

Chamber Attested: ${form.chamberAttested}
...
`;
  ...
  const handleSubmitWhatsApp = () => {
    if (!validateStep()) return;
    const message = `
*Commercial Document Attestation Inquiry*
      ...
      <div className="max-h-[90vh] w-full max-w-4xl overflow-y-auto rounded-3xl border border-white/10 bg-[#162235] text-white shadow-2xl">
        ...
        <div className="p-6">
          ...
          {step === 3 && (
            <div className="grid gap-5 md:grid-cols-2">
              <Select
                label={t.chamberAttested}
                name="chamberAttested"
                value={form.chamberAttested}
                onChange={handleChange}
                options={["Yes", "No", "Not Sure"]}
                error={errors.chamberAttested}
              />
