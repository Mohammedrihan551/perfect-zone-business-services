...
export default function BirthCertificateAttestationPopup({
  open,
  onClose,
  currentStep,
  name,
  ...
  const t = isArabic
    ? {
        ...
        setupTag: "خدمات تصديق شهادة الميلاد",
    ...
    : {
        ...
        setupTag: "Birth Certificate Attestation Services",
  ...
  const handleSubmitEmail = () => {
    ...
    const subject = "Birth Certificate Attestation Inquiry";
...
`;
  ...
  const handleSubmitWhatsApp = () => {
    if (!validateStep()) return;
    const message = `
*Birth Certificate Attestation Inquiry*
