...
export default function MedicalTranslationPopup({
  open,
  onClose,
  currentStep,
  name,
  ...
  const t = isArabic
    ? {
        ...
        documentType: "نوع المستند الطبي *",
        sourceLanguage: "لغة المستند الأصلية *",
        targetLanguage: "لغة الترجمة المطلوبة *",
        pageCount: "عدد الصفحات *",

        purpose: "الغرض من الترجمة",
        certifiedTranslation: "هل تحتاج ترجمة معتمدة؟",
        urgentService: "خدمة مستعجلة؟",
        hardCopy: "هل تحتاج نسخة مطبوعة؟",
    ...
    : {
        ...
        setupTag: "Medical Translation Services",
  ...
  const handleSubmitEmail = () => {
    ...
    const subject = "Medical Translation Service Inquiry";
...
Hard Copy Required: ${form.hardCopy}
...
`;
  ...
  const handleSubmitWhatsApp = () => {
    if (!validateStep()) return;
    const message = `
*Medical Translation Service Inquiry*
