...
export default function MOFAAttestationPopup({
  open,
  onClose,
  currentStep,
  name,
  ...
  const t = isArabic
    ? {
        ...
        setupTag: "خدمات تصديق وزارة الخارجية",
        ...
        documentCountry: "بلد إصدار الوثيقة *",
        documentCount: "عدد الوثائق *",
        purpose: "الغرض من التصديق *",

        embassyAttested: "هل تم تصديق السفارة؟",
        urgentService: "خدمة مستعجلة؟",
        deliveryRequired: "هل تحتاج للاستلام والتوصيل؟",
        translationRequired: "هل تحتاج إلى ترجمة؟",
    ...
    : {
        ...
        setupTag: "MOFA Attestation Services",
        ...
        embassyAttested: "Embassy Attested Already?",
        urgentService: "Need Urgent Service?",
        deliveryRequired: "Pickup & Delivery Required?",
  ...
  const validateStep = () => {
    ...
    if (step === 2) {
      ...
      if (!form.documentCountry)
        newErrors.documentCountry = "Please select issuing country";
...
Embassy Attested: ${form.embassyAttested}
Urgent Service: ${form.urgentService}
Pickup & Delivery: ${form.deliveryRequired}
      ...
      <div className="max-h-[90vh] w-full max-w-4xl overflow-y-auto rounded-3xl border border-white/10 bg-[#162235] text-white shadow-2xl">
        ...
        <div className="p-6">
          ...
          {step === 3 && (
            <div className="grid gap-5 md:grid-cols-2">
              <Select
                label={t.embassyAttested}
                name="embassyAttested"
                value={form.embassyAttested}
                onChange={handleChange}
                options={["Yes", "No", "Not Sure"]}
                error={errors.embassyAttested}
              />
