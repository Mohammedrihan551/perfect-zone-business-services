...
export default function EmbassyAttestationPopup({
  open,
  onClose,
  currentStep,
  name,
  ...
  const t = isArabic
    ? {
        ...
        embassyCountry: "السفارة المطلوبة *",
        documentCount: "عدد الوثائق *",
        purpose: "الغرض من التصديق *",

        mofaAttested: "هل تم تصديق الخارجية؟",
        urgentService: "خدمة مستعجلة؟",
        pickupRequired: "هل تحتاج للاستلام والتوصيل؟",
    ...
    : {
        ...
        setupTag: "Embassy Attestation Services",
        ...
        embassyCountry: "Embassy Required *",
        documentCount: "Number of Documents *",
        purpose: "Purpose of Attestation *",

        mofaAttested: "MOFA Attested Already?",
        urgentService: "Need Urgent Service?",
        pickupRequired: "Pickup & Delivery Required?",
  ...
  const validateStep = () => {
    ...
    if (step === 2) {
      ...
      if (!form.embassyCountry)
        newErrors.documentCountry = "Please select Embassy";
  ...
  const handleSubmitEmail = () => {
    ...
    const subject = "MOFA Attestation Inquiry";
...
EmbassyCountry: ${form.embassyCountry}
Document Count: ${form.documentCount}
Purpose: ${form.purpose}

Embassy Attested: ${form.mofaAttested}
Urgent Service: ${form.urgentService}
Pickup & Delivery: ${form.pickupRequired}
...
MOFA Attested: ${form.mofaAttested}
Urgent Service: ${form.urgentService}
Pickup & Delivery: ${form.pickupRequired}
Translation Required: ${form.translationRequired}
        ...
        <div className="p-6">
          ...
          {step === 2 && (
            <div className="grid gap-5 md:grid-cols-2">
              ...
              <CountrySelect
                label={t.embassyCountry}
                value={form.embassyCountry}
                error={errors.embassyCountry}
                isArabic={isArabic}
                onChange={(country) =>
                  setForm((prev) => ({
                    ...prev,
                    embassyCountry: country,
                  }))
                }
              />
          ...
          {step === 3 && (
            <div className="grid gap-5 md:grid-cols-2">
              <Select
                label={t.mofaAttested}
                name="mofaAttested"
                value={form.mofaAttested}
                onChange={handleChange}
              ...
              <Select
                label={t.pickupRequired}
                name="pickupRequired"
                value={form.pickupRequired}
                onChange={handleChange}
                options={["Yes", "No"]}
              />
