...
export default function BusinessConsultancyPopup({
  open,
  onClose,
  currentStep,
  name,
  ...
  const t = isArabic
    ? {
        ...
        popupSubtitle: "أكمل النموذج وسيتواصل معك مستشارونا.",
        setupTag: "خدمات الاستشارات التجارية",
        ...
        consultancyType: "نوع الاستشارة *",
        businessStage: "مرحلة العمل",
        industry: "القطاع / المجال *",
        challenge: "التحديات الحالية *",

        companySize: "حجم الشركة",
        employees: "عدد الموظفين",
        marketExpansion: "التوسع في السوق؟",
        funding: "هل تحتاج إلى تمويل؟",

        strategySupport: "دعم الاستراتيجية؟",
        operationsSupport: "تحسين العمليات؟",
        complianceSupport: "الدعم التنظيمي؟",
    ...
    : {
        ...
        popupSubtitle:
          "Complete the form and our consultants will contact you.",
        setupTag: "Business Consultancy Services",
        ...
        marketExpansion: "Planning Market Expansion?",
        funding: "Need Funding Support?",

        strategySupport: "Need Strategy Support?",
        operationsSupport: "Need Operations Improvement?",
        complianceSupport: "Need Compliance Support?",

        timeline: "Consultation Timeline",
        budget: "Budget",
        implementation: "Need Implementation Support?",
  ...
  const validateStep = () => {
    ...
    if (step === 2) {
      if (!form.consultancyType)
        newErrors.consultancyType = "Please select consultancy type";

      if (!form.industry) newErrors.industry = "Please select industry";

      if (!form.challenge.trim())
        newErrors.challenge = "Please describe current challenges";
    }
  ...
  const handleSubmitEmail = () => {
    ...
    const subject = "Business Consultancy Inquiry";
...
Consultancy Type: ${form.consultancyType}
...
Market Expansion: ${form.marketExpansion}
Funding Support: ${form.funding}
Strategy Support: ${form.strategySupport}
Operations Improvement: ${form.operationsSupport}
Compliance Support: ${form.complianceSupport}

Implementation Support: ${form.implementation}
        ...
        <div className="p-6">
          ...
          {step === 3 && (
            <div className="grid gap-5 md:grid-cols-2">
              ...
              <Select
                label={t.marketExpansion}
                name="marketExpansion"
                value={form.marketExpansion}
                onChange={handleChange}
                options={["Yes", "No"]}
              ...
              <Select
                label={t.strategySupport}
                name="strategySupport"
                value={form.strategySupport}
                onChange={handleChange}
                options={["Yes", "No"]}
                error={errors.strategySupport}
              />

              <Select
                label={t.operationsSupport}
                name="operationsSupport"
                value={form.operationsSupport}
                onChange={handleChange}
                options={["Yes", "No"]}
                error={errors.operationsSupport}
              />

              <Select
                label={t.complianceSupport}
                name="complianceSupport"
                value={form.complianceSupport}
                onChange={handleChange}
                options={["Yes", "No"]}
                error={errors.complianceSupport}
              />
            </div>
          )}
