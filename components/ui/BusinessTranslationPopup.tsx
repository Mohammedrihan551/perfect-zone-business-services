...
export default function BusinessTranslationPopup({
  open,
  onClose,
  currentStep,
  name,
  ...
  const t = isArabic
    ? {
        ...
        setupTag: "خدمات الترجمة التجارية",
        ...
        documentType: "نوع المستند التجاري *",
        industry: "قطاع الأعمال *",
        sourceLanguage: "لغة المستند الأصلية *",
        targetLanguage: "لغة الترجمة المطلوبة *",

        pageCount: "عدد الصفحات *",
        translationPurpose: "الغرض من الترجمة",
        urgentService: "خدمة مستعجلة؟",
        formattingRequired: "الحفاظ على التنسيق الأصلي؟",
    ...
    : {
        ...
        setupTag: "Business Translation Services",
        ...
        documentType: "Business Document Type *",
        industry: "Business Industry *",
        sourceLanguage: "Source Language *",
        targetLanguage: "Target Language *",

        pageCount: "Number of Pages *",
        translationPurpose: "Purpose of Translation",
        urgentService: "Need Urgent Service?",
        formattingRequired: "Preserve Original Formatting?",
  ...
  const validateStep = () => {
    ...
    if (step === 2) {
      ...
      if (!form.sourceLanguage)
        newErrors.sourceLanguage = "Please select source language";

      if (!form.targetLanguage)
        newErrors.targetLanguage = "Please select target language";
    }

    if (step === 3) {
      if (!form.pageCount)
        newErrors.pageCount = "Please select Number of Pages";
    }
  ...
  const handleSubmitEmail = () => {
    ...
    const subject = "Business Translation Service Inquiry";
...
Translation Purpose: ${form.translationPurpose}
Urgent Service: ${form.urgentService}
Formatting Required: ${form.formattingRequired}
...
`;
  ...
  const handleSubmitWhatsApp = () => {
    if (!validateStep()) return;
    const message = `
*Business Translation Service Inquiry*
        ...
        <div className="p-6">
          ...
          {step === 3 && (
            <div className="grid gap-5 md:grid-cols-2">
              ...
              <Select
                label={t.translationPurpose}
                name="translationPurpose"
                value={form.translationPurpose}
                onChange={handleChange}
                options={[
                ...
                error={errors.translationPurpose}
              />
              ...
              <Select
                label={t.formattingRequired}
                name="formattingRequired"
                value={form.formattingRequired}
                onChange={handleChange}
                options={["Yes", "No"]}
                error={errors.formattingRequired}
              />
            </div>
          )}
