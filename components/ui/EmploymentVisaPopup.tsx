...
export default function EmploymentVisaPopup({
  open,
  onClose,
  currentStep,
  name,
  ...
  const t = isArabic
    ? {
        ...
        visaType: "نوع تأشيرة العمل *",
        jobRole: "المسمى الوظيفي *",
        employerStatus: "حالة جهة العمل *",
        currentLocation: "الموقع الحالي *",

        contractReady: "هل عقد العمل جاهز؟",
        workPermit: "هل تصريح العمل مطلوب؟",
        documentsReady: "هل المستندات جاهزة؟",
        medicalRequired: "هل الفحص الطبي مطلوب؟",
    ...
    : {
        ...
        setupTag: "Employment Visa Assistance",
  ...
  const validateStep = () => {
    ...
    if (step === 2) {
      if (!form.visaType) newErrors.visaType = "Please select visa type";

      if (!form.jobRole.trim()) newErrors.jobRole = "Job role is required";

      if (!form.employerStatus)
        newErrors.employerStatus = "Please select employer status";

      if (!form.currentLocation)
        newErrors.currentLocation = "Please select current location";
    }
    ...
    if (step === 4) {
      ...
      if (!form.budget) newErrors.budget = "Please select setup budget";
    }
  ...
  const handleSubmitEmail = () => {
    ...
    const subject = "Employment Visa Inquiry";

    const body = `
EMPLOYMENT VISA INQUIRY
...
Employer Status: ${form.employerStatus}
Current Location: ${form.currentLocation}

Contract Ready: ${form.contractReady}
Work Permit Required: ${form.workPermit}
Documents Ready: ${form.documentsReady}
Medical Required: ${form.medicalRequired}
        ...
        <div className="p-6">
          ...
          {step === 2 && (
            <div className="grid gap-5 md:grid-cols-2">
              ...
              <Select
                label={t.employerStatus}
                name="employerStatus"
                value={form.employerStatus}
                onChange={handleChange}
                options={[
                  "Private Company",
                  "Government Entity",
              ...
              <Select
                ...
                onChange={handleChange}
                options={["Inside UAE", "Outside UAE", "Visit Visa Holder"]}
          ...
          {step === 3 && (
            <div className="grid gap-5 md:grid-cols-2">
              <Select
                ...
                name="contractReady"
                value={form.contractReady}
                onChange={handleChange}
                options={["Yes", "No", "In Progress"]}
                error={errors.contractReady}
              />
              ...
              <Select
                label={t.medicalRequired}
                name="medicalRequired"
                value={form.medicalRequired}
                onChange={handleChange}
                options={["Yes", "No", "Not Sure"]}
                error={errors.medicalRequired}
              />
            </div>
          )}
