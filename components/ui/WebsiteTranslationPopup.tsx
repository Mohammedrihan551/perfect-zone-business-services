...
export default function WebsiteTranslationPopup({
  open,
  onClose,
  currentStep,
  name,
  ...
  const t = isArabic
    ? {
        ...
        setupTag: "خدمات ترجمة المواقع الإلكترونية",
        ...
        websiteType: "نوع الموقع الإلكتروني *",
        industry: "قطاع الأعمال *",
        sourceLanguage: "لغة الموقع الحالية *",
        targetLanguage: "اللغة المطلوبة *",

        pageCount: "عدد الصفحات *",
        cmsPlatform: "منصة الموقع",
        seoRequired: "ترجمة SEO مطلوبة؟",
        contentUpdates: "هل تحتاج إدخال المحتوى؟",

        timeline: "الجدول الزمني",
        budget: "الميزانية",
        notes: "رابط الموقع أو متطلبات إضافية...",
    ...
    : {
        ...
        setupTag: "Website Translation Services",
        ...
        sourceLanguage: "Current Website Language *",
        targetLanguage: "Target Language *",

        pageCount: "Number of Pages *",
        cmsPlatform: "Website Platform",
        seoRequired: "Need SEO Translation?",
        contentUpdates: "Need Content Upload / Updates?",

        timeline: "Project Timeline",
        budget: "Budget",
        notes: "Website URL or additional requirements...",
  ...
  const handleSubmitEmail = () => {
    ...
    const subject = "Website Translation Service Inquiry";
...
Current Language: ${form.sourceLanguage}
...
`;
  ...
  const handleSubmitWhatsApp = () => {
    if (!validateStep()) return;
    const message = `
*Website Translation Service Inquiry*
