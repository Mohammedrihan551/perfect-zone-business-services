...
export default function GoldenVisaPopup({
  open,
  onClose,
  currentStep,
  name,
  ...
  const t = isArabic
    ? {
        ...
        setupTag: "خدمات التأشيرة الذهبية",
        ...
        currentResidence: "مكان الإقامة الحالي *",
        profession: "المهنة / المجال *",
        eligibilityCategory: "فئة الأهلية *",

        familyMembers: "عدد أفراد العائلة",
        sponsorNeeded: "هل تحتاج كفالة عائلية؟",
        relocation: "هل تخطط للانتقال إلى الإمارات؟",
        documentReady: "هل المستندات جاهزة؟",
    ...
    : {
        ...
        setupTag: "Golden Visa Assistance",
        ...
        sponsorNeeded: "Need Family Sponsorship?",
        relocation: "Planning to Relocate to UAE?",
  ...
  const validateStep = () => {
    ...
    if (step === 2) {
      ...
      if (!form.eligibilityCategory)
        newErrors.eligibilityCategory = "Please select eligibility category";
    }
  ...
  const handleSubmitEmail = () => {
    ...
    const subject = "Golden Visa Inquiry";
...
Eligibility Category: ${form.eligibilityCategory}

Family Members: ${form.familyMembers}
Family Sponsorship: ${form.sponsorNeeded}
Relocation to UAE: ${form.relocation}
Documents Ready: ${form.documentReady}
        ...
        <div className="p-6">
          ...
          {step === 2 && (
            <div className="grid gap-5 md:grid-cols-2">
              ...
              <Select
                ...
                error={errors.eligibilityCategory}
              />
            </div>
          )}
          ...
          {step === 3 && (
            <div className="grid gap-5 md:grid-cols-2">
              ...
              <Select
                label={t.sponsorNeeded}
                name="sponsorNeeded"
                value={form.sponsorNeeded}
                onChange={handleChange}
                options={["Yes", "No"]}
                error={errors.sponsorNeeded}
              />
              ...
              <Select
                label={t.documentReady}
                name="documentReady"
                value={form.documentReady}
                onChange={handleChange}
                options={["Yes", "No", "Partially"]}
                error={errors.documentReady}
              />
            </div>
          )}
