...
export default function CostCalculatorPopup({
  open,
  onClose,
  setOpenServicePopup,
  setSelectedService,
  ...
  const t = isArabic
    ? {
        popupTitle: "احصل على تقدير تكلفة خدمتك",
        popupSubtitle: "أكمل النموذج وسيتواصل معك خبراؤنا.",
        setupTag: "تقدير التكلفة",
  ...
  const validateStep = () => {
    ...
    if (step === 2) {
      if (!form.notes) newErrors.timeline = "Addtional note is required";
    }
  ...
  const handleNext = () => {
    ...
    if (form.serviceType && form.serviceType != "Other") {
      ...
      setEmail(form.email);
      setNationality(form.nationality);
    }
  };
        ...
        <div className="p-6">
          {step === 1 && (
            <div className="grid gap-5 md:grid-cols-2">
              ...
              {form.service == "Business Setup" ||
              form.service == "Attestation Services" ||
              form.service == "Translation Services" ||
              form.service == "Visa Services" ? (
                <Select
                  label={t.serviceType}
                  name="serviceType"
