...
export default function CorporateBankPopup({
  open,
  onClose,
  currentStep,
  name,
  ...
  const t = isArabic
    ? {
        ...
        setupTag: "خدمات الحساب المصرفي للشركات",
        ...
        annualRevenue: "الإيرادات السنوية المتوقعة",

        bankLocation: "البنك المفضل",
        accountType: "نوع الحساب",
        transactionVolume: "حجم المعاملات الشهري",
        internationalTransfers: "تحويلات دولية؟",

        existingLicense: "هل لديك رخصة تجارية؟",
        residency: "هل لديك إقامة إماراتية؟",
        multiCurrency: "حساب متعدد العملات؟",
    ...
    : {
        ...
        setupTag: "Corporate Bank Account Services",
        ...
        annualRevenue: "Expected Annual Revenue",

        bankLocation: "Preferred Bank",
        accountType: "Account Type",
        transactionVolume: "Monthly Transaction Volume",
        internationalTransfers: "International Transfers?",

        existingLicense: "Have Trade License?",
        residency: "Have UAE Residency?",
        multiCurrency: "Need Multi-Currency Account?",
  ...
  const validateStep = () => {
    ...
    if (step === 3) {
      if (!form.bankLocation)
        newErrors.bankLocation = "Please select preferred bank";
    }
  ...
  const handleSubmitEmail = () => {
    ...
    const subject = "Corporate Bank Account Inquiry";
...
Business Activity:
${form.activity}
Expected Revenue: ${form.annualRevenue}

Preferred Bank: ${form.bankLocation}
Account Type: ${form.accountType}
Monthly Transaction Volume: ${form.transactionVolume}
International Transfers: ${form.internationalTransfers}

Trade License: ${form.existingLicense}
UAE Residency: ${form.residency}
Multi-Currency Account: ${form.multiCurrency}
...
`;
  ...
  const handleSubmitWhatsApp = () => {
    if (!validateStep()) return;
    const message = `
*Corporate Bank Account Inquiry*
        ...
        <div className="p-6">
          ...
          {step === 3 && (
            <div className="grid gap-5 md:grid-cols-2">
              ...
              <Select
                label={t.internationalTransfers}
                name="internationalTransfers"
                value={form.internationalTransfers}
                onChange={handleChange}
                options={["Yes", "No"]}
                error={errors.internationalTransfers}
              />

              <Select
                label={t.existingLicense}
