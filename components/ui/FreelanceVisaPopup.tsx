...
export default function FreelanceVisaPopup({
  open,
  onClose,
  currentStep,
  name,
  ...
  const t = isArabic
    ? {
        ...
        setupTag: "خدمات تأشيرة العمل الحر",
        ...
        profession: "المهنة / المجال *",
        workCategory: "فئة العمل الحر *",
        experience: "سنوات الخبرة *",
        currentLocation: "الموقع الحالي *",

        portfolioReady: "هل لديك معرض أعمال / Portfolio؟",
        clientsAvailable: "هل لديك عملاء حاليون؟",
        visaNeed: "هل تحتاج إقامة في الإمارات؟",
    ...
    : {
        ...
        setupTag: "Freelance Visa Assistance",
        ...
        workCategory: "Freelance Category *",
        experience: "Years of Experience *",
        currentLocation: "Current Location *",

        portfolioReady: "Portfolio Available?",
        clientsAvailable: "Existing Clients?",
        visaNeed: "Need UAE Residence Visa?",
  ...
  const validateStep = () => {
    ...
    if (step === 2) {
      if (!form.workCategory)
        newErrors.workCategory = "Please select freelance category";
  ...
  const handleSubmitEmail = () => {
    ...
    const subject = "Freelance Visa Inquiry";
...
Freelance Category: ${form.workCategory}
Experience: ${form.experience}
Current Location: ${form.currentLocation}

Portfolio Available: ${form.portfolioReady}
Existing Clients: ${form.clientsAvailable}
Need UAE Residence Visa: ${form.visaNeed}
          ...
          {step === 3 && (
            <div className="grid gap-5 md:grid-cols-2">
              <Select
                ...
                name="portfolioReady"
                value={form.portfolioReady}
                onChange={handleChange}
                options={["Yes", "No", "In Progress"]}
                error={errors.portfolioReady}
              />

              <Select
                label={t.clientsAvailable}
                name="clientsAvailable"
                value={form.clientsAvailable}
                onChange={handleChange}
                options={["Yes", "No", "Few Clients"]}
                error={errors.clientsAvailable}
              />
